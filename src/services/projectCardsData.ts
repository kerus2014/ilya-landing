import logo1 from "../assets/pics/ProjectEtno.png";
import logo2 from "../assets/pics/ProjectCyberGuard.png";
import logo3 from "../assets/pics/ProjectPixelLab.png";
import logo4 from "../assets/pics/ProjectAgroTourism.png";

export const projectCardsData = [
  {
    image: logo1,
    title: "Сувениры со смыслом Etno.by",
  ...
  {
    image: logo2,
    title: "Travel Tech проекты Cyber Guard",
  ...
  {
    image: logo3,
    title: "Туристические продукты Pixel Lab",
  ...
  {
    image: logo4,
    title: "Образовательная платформа Agrotourism Pro",
