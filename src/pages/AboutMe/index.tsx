      ...
      <Title title="Моя история"/>
        <div className={styles["history__content-container"]}>
          ...
          <div className={styles["history__right-side"]}>
            <p className={styles["history__presentation"]}>Я Илья Давыдов - предприниматель и основатель стартапов в сфере туризма.</p>
      ...
      <BlockTemplate className={styles.interests}>
        ...
        <div className={styles["interests__row"]}>
          {/* <div className={styles["interests__row-item"]}> */}
            ...
            <div className={styles["interests__img-container"]}>
        ...
        <p className={styles["interests__last-paragraph"]}>Если сферы наших интересов совпадают - буду рад знакомству, общению и сотрудничеству.</p>
      </BlockTemplate>
    </>
  );
};
